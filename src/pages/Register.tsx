    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 px-4">
      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-emerald-600 dark:text-emerald-500 mb-2">Create Account</h1>
          <p className="text-zinc-500 dark:text-zinc-400">Start your financial journey today.</p>
        </div>
